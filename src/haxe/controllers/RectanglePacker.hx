...
class RectanglePacker
{
    ...
    public var rectangles (get, never):Array<IntegerRectangle>;
    function get_rectangles():Int { return mInsertedRectangles; }
     ...
     * @return
     */
    public function getRectangle(index:Int):IntegerRectangle
    {
